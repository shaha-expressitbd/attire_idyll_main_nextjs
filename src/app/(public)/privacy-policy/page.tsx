...
export default function PrivacyPolicyPage() {
        ...
        <div className="space-y-4">
          <div className="grid gap-3">
            {[
              ...
              <div key={index} className="flex items-start space-x-3 p-3 rounded-lg bg-gradient-to-r from-primary/10 to-primary/20 dark:from-primary/20 dark:to-primary/40 border border-primary/30 dark:border-primary/50">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="bg-gradient-to-r from-primary/10 to-primary/20 dark:from-primary/20 dark:to-primary/40 border border-primary/30 dark:border-primary/50 p-4 rounded-lg">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-tertiary/5 to-secondary/5 dark:from-slate-900 dark:via-primary/10 dark:to-secondary/10 md:mt-16 mt-0">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-br from-tertiary/20 to-primary/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
      </div>
      ...
      <main className={`relative mx-auto max-w-7xl md:px-4 px-2 md:py-12 py-6 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
        ...
        <div className="text-center md:mb-16 mb-8">
          ...
          <p className="text-sm md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Learn how Attire_Idyll collects, uses, shares, and protects your data with complete transparency.
          </p>
        </div>
              ...
              <div className="bg-white dark:bg-secondary backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 dark:border-slate-700/20 overflow-hidden hover:shadow-2xl transition-all duration-300">
                ...
                >
                  <div className="flex items-center space-x-4">
                    <div className="flex items-center justify-center md:w-12 md:h-12 w-8 h-8 bg-gradient-to-r from-primary to-secondary rounded-xl text-white shadow-lg p-1">
                      {section.icon}
                    </div>
                    <div>
                ...
                <div className={`overflow-hidden transition-all duration-500 ${activeSection === section.id ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
                  <div className="p-6 pt-0 border-t border-gray-100 dark:border-gray-700 text-sm md:text-base">
                    {section.content}
                  </div>
                </div>
              </div>
