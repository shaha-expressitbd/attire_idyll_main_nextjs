...
const ProductCardSkeleton = () => {
  return (
    <div className="group relative py-2">
      <div className="relative rounded-2xl bg-primary dark:bg-secondary border border-gray-300 dark:border-gray-800 shadow-sm">
        ...
        {/* Bottom Content */}
        <div className="p-3 sm:p-4 bg-green-50/40">
